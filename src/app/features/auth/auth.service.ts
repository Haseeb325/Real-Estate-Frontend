...
clearAuthState() {
  ...
  localStorage.removeItem('email');
    ...
    verifyOtp(payload:any){
        ...
        return this.apiService.post(URLConfig.verifyOtp,payload,{
    ...
    regStep2(payload:any){
        this._loading.set(true)
        return this.apiService.post(URLConfig.regStep2,payload,{
            withCredentials:true,
            headers:{
                token:this.tempToken() || ''
            }
...
this.handleError(),this.finalize()
    ...
    regStep3(payload:any){
        this._loading.set(true)
        return this.apiService.post(URLConfig.regStep3,payload,{
            withCredentials:true,
            headers:{
                token:this.tempToken() || ''
            }
    ...
    forgotPassword(payload:any){
        this._loading.set(true)
        return this.apiService.post(URLConfig.forgotPassword,payload,{
            withCredentials:true,
            headers:{
                token:this.tempToken() || '',
